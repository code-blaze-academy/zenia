...
class SavingBoxViewset(viewsets.ViewSet):
    ...
    def list(self,request):
        ...
        stl_path = os.path.join('threedmodels', "saving_box.stl")
        exporters.export(result,stl_path)
        return Response({'status':True,
            'stl_url': request.build_absolute_uri(f'/threedmodels/saving_box.stl'),
